            ...
            return Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Container(decoration: const BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(12))), child: Image.network(data[index].imageUrl[0].imageUrl)),
                      const SizedBox(width: 10),
                      Column(
                        mainAxisAlignment:
                        MainAxisAlignment.start,
                        ...
                        CrossAxisAlignment.start,
                        children: [
                          ReusableText(text: data[index].name, style: appstyle(12, Colors.black, FontWeight.bold)),
                          ReusableText(text: "${data[index].price} \VNĐ", style: appstyle(12, Colors.black, FontWeight.w400)),
                          ReusableText(text: data[index].quantity.toString(), style: appstyle(12, Colors.black, FontWeight.w400)),
                        ],
                      ),
                    ],
                  ),
