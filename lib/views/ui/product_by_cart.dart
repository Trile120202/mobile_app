...
class _ProductByCatState extends State<ProductByCat>
  ...
  late Future<List<Products>> _orthers;
  ...
  void getOrther() {
    _orthers = Helper().getOrtherProducts();
  }
  ...
  List<String> brand = [
    "assets/image/Whiskas.png",
    "assets/image/royal canini.png",
    "assets/image/purina.png",
    "assets/image/ME-O.png",
  ];
  @override
            ...
            Padding(
              ...
              child: ClipRRect(
                ...
                child: TabBarView(controller: _tabController, children: [
                  latestProducts(dog: _dog),
                  latestProducts(dog: _cat),
                  latestProducts(dog: _orthers),
                ]),
              ),
            )
          ],
